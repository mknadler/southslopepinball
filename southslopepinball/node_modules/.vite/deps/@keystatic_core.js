...
// node_modules/.pnpm/@keystatic+core@0.5.11_react-dom@18.2.0_react@18.2.0/node_modules/@keystatic/core/dist/api-c6118282.js
...
// node_modules/.pnpm/@keystatic+core@0.5.11_react-dom@18.2.0_react@18.2.0/node_modules/@keystatic/core/dist/keystatic-core.js
var import_jsx_runtime3 = __toESM(require_jsx_runtime());
var import_react3 = __toESM(require_react());

// node_modules/.pnpm/@keystatic+core@0.5.11_react-dom@18.2.0_react@18.2.0/node_modules/@keystatic/core/dist/index-ae1a582b.js
...
function validateUrl(validation, value, label) {
  if (value !== null && (typeof value !== "string" || !isValidURL$2(value))) {
...
function ImageField(props) {
  ...
  const onLoad = useEventCallback$1((data) => {
    onChange(data);
    setStatus("good");
  });
  ...
  (0, import_react3.useEffect)(() => {
    ...
    if (!isValidURL$2(props.image.src)) {
      return;
    }
    if (hasSetFields) {
      setStatus("good");
  ...
  return (0, import_jsx_runtime3.jsxs)(VStack, {
    gap: "xlarge",
    children: [(0, import_jsx_runtime3.jsxs)(HStack, {
      gap: "medium",
      alignItems: "end",
      children: [(0, import_jsx_runtime3.jsx)(TextField, {
        flex: true,
