import React__default, { useState, useMemo, useEffect, useContext, createContext, startTransition, useCallback, useRef, cloneElement, forwardRef, useId, createElement, memo, Fragment as Fragment$1, useReducer, useSyncExternalStore } from 'react';
...
import { css, breakpoints, useMediaQuery, tokenSchema, transition, containerQueries, toDataAttributes, breakpointQueries, classNames, useBreakpoint, injectGlobal } from '@keystar/ui/style';
...
import { g as getPathPrefix, t as treeEntriesToTreeNodes, P as PKG_VERSION, K as KEYSTATIC_CLOUD_API_URL, a as KEYSTATIC_CLOUD_HEADERS, i as isGitHubConfig, r as redirectToCloudAuth, b as getEntriesInCollectionWithTreeKey, c as getSingletonPath, d as getTreeNodeAtPath, e as treeSha, f as treeToEntries, h as getBranchPrefix, n as nodeTypeMatcher, u as updateValue, j as getKeysForArrayValue, s as setKeysForArrayValue, k as getSlugFromState, l as getInitialPropsValue, m as getAncestorComponentChildFieldDocumentFeatures, o as isBlock, p as allMarks, q as isListNode, v as isElementActive, w as getWholeDocumentFeaturesForChildField, x as getInitialPropsValueFromInitializer, y as aliasesToLabel, z as aliasesToCanonicalName, A as canonicalNameToLabel, B as labelToCanonicalName, C as languagesWithAliases, D as transformProps, E as getValueAtPropPath, F as cloneDescendent, G as areArraysEqual, H as getSchemaAtPropPath, I as findChildPropPaths, J as object, L as getSelectedTableArea, M as getRelativeRowPath, N as cell, O as clearFormatting, Q as EditorAfterButIgnoringingPointsWithNoContent, R as getInlineNodes, S as addMarksToChildren, T as setLinkForChildren, U as forceDisableMarkForChildren, V as addMarkToChildren, W as getPlaceholderTextForPropPath, X as Prism, _ as _createDocumentEditor, Y as getSplitCloudProject, Z as getRepoUrl, $ as isLocalConfig, a0 as pluralize, a1 as getEntryDataFilepath, a2 as getDirectoriesForTreeKey, a3 as getTreeKey, a4 as blobSha, a5 as getCollectionPath, a6 as getCollectionFormat, a7 as getCollectionItemPath, a8 as getSlugGlobForCollection, a9 as serializeProps, aa as updateTreeWithChanges, ab as yjsToVal, ac as parsedValToYjs, ad as getNewArrayElementKey, ae as getYjsValFromParsedValue, af as getDataFileExtension, ag as getSingletonFormat, ah as isCloudConfig } from './index-0756fbb7.node.react-server.js';
import { LRUCache } from 'lru-cache';
import { isDefined, assert, assertNever, typedKeys } from 'emery';
...
import { Dialog, DialogContainer, useDialogContainer, AlertDialog, DialogTrigger } from '@keystar/ui/dialog';
...
import { t as toFormattedFormDataError, v as validateArrayLength, P as PropValidationError, l as loadDataFile, p as parseProps } from './required-files-852081de.node.react-server.js';
...
import { toUint8Array as toUint8Array$1, fromUint8Array } from 'js-base64';
...
import './index-93f6867d.node.react-server.js';
